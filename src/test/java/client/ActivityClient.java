...
import payload.ActivityPayload;

import static io.restassured.RestAssured.given;

public class ActivityClient {

    private final ActivityPayload activityPayload = new ActivityPayload();
    private static final Logger logger = LogManager.getLogger(ActivityClient.class);
